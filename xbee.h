...
xbee_err xbee_pktGetDigital(struct xbee_pkt *pkt, int channel, int index, int *retVal);
xbee_err xbee_pktGetAnalog(struct xbee_pkt *pkt, int channel, int index, int *retVal);
