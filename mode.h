...
struct xbee_mode {
	...
	xbee_err (* const rx_io)(struct xbee *xbee, struct xbee_buf **buf, void *arg); /* retrieves raw buffers from the I/O device */
	xbee_err (* const tx_io)(struct xbee *xbee, struct xbee_buf *buf, void *arg); /* transmits raw buffers to the I/O device */
