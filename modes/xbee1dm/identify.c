...
xbee_err xbee_s1dm_identify_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
struct xbee_modeDataHandlerRx xbee_s1dm_identify_rx  = {
	.identifier = 0x95,
	.func = xbee_s1dm_identify_rx_func,
};
struct xbee_modeConType xbee_s1dm_identify = {
	.name = "Identify",
	.allowFrameId = 0,
	.useTimeout = 0,
	.addressRules = ADDR_NONE,
	.rxHandler = &xbee_s1dm_identify_rx,
	.txHandler = NULL,
};
