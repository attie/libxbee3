...
xbee_err xbee_s1dm_io_parseInputs(struct xbee *xbee, struct xbee_pkt *pkt, unsigned char *data, int len) {
	int sampleCount;
	int sample, channel;
	int ioMask;
...
xbee_err xbee_s1dm_io_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
xbee_err xbee_s1dm_io_rx_funcPost(struct xbee *xbee, struct xbee_con *con, struct xbee_pkt *pkt) {
...
struct xbee_modeDataHandlerRx xbee_s1dm_io_rx  = {
	.identifier = 0x92,
	.func = xbee_s1dm_io_rx_func,
	.funcPost = xbee_s1dm_io_rx_funcPost,
};
struct xbee_modeConType xbee_s1dm_io = {
	.name = "I/O",
	.allowFrameId = 0,
	.useTimeout = 0,
