...
xbee_err xbee_s3_transmitStatus_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
xbee_err xbee_s3_modemStatus_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
	struct xbee_pkt *iPkt;
	xbee_err ret;
...
static const struct xbee_modeConType *conTypes[] = {
	&xbee_s3_transmitStatus, /* done */
	&xbee_s3_modemStatus, /* done */
	&xbee_s3_localAt, /* done */
	&xbee_s3_remoteAt, /* done */
	&xbee_s3_data, /* done */
	&xbee_s3_dataExp, /* done */
	&xbee_s3_identify, /* done */
	NULL
};

XBEE_DECLARE_MODE(xbee3) = {
	.name = "xbee3",
