...
void xbee_sZB_createSourceRoute_init(struct xbee_modeConType *conType) {
	...
	conType->txHandler->identifier = 0x21;
	conType->txHandler->func = xbee_sZB_createSourceRoute_tx_func;
}
struct xbee_modeDataHandlerTx xbee_sZB_createSourceRoute_tx;
struct xbee_modeConType xbee_sZB_createSourceRoute = { "Create Source Route", NULL, &xbee_sZB_createSourceRoute_tx, xbee_sZB_createSourceRoute_init };
...
void xbee_sZB_routeRecordIndicator_init(struct xbee_modeConType *conType) {
	/* we REALLY have to babysit Windows... */
	conType->allowFrameId = 0;
	conType->useTimeout = 0;
	...
	conType->addressRules = ADDR_EP_NOTALLOW;
	conType->save_addr16 = 1;
	conType->save_addr64 = 1;
	conType->rxHandler->identifier = 0xA1;
	conType->rxHandler->func = xbee_sZB_routeRecordIndicator_rx_func;
}
struct xbee_modeDataHandlerRx xbee_sZB_routeRecordIndicator_rx;
struct xbee_modeConType xbee_sZB_routeRecordIndicator = { "Route Record Indicator", &xbee_sZB_routeRecordIndicator_rx, NULL, xbee_sZB_routeRecordIndicator_init };
