...
xbee_err xbee_s6_transmitStatus_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
struct xbee_modeDataHandlerRx xbee_s6_transmitStatus_rx  = {
	.identifier = 0x89,
	.func = xbee_s6_transmitStatus_rx_func,
};
struct xbee_modeConType xbee_s6_transmitStatus = {
	.name = "Transmit Status",
	.allowFrameId = 1,
	.useTimeout = 0,
	.addressRules = ADDR_NONE,
	.rxHandler = &xbee_s6_transmitStatus_rx,
	.txHandler = NULL,
};

/* ######################################################################### */

xbee_err xbee_s6_modemStatus_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
	struct xbee_pkt *iPkt;
	xbee_err ret;
...
struct xbee_modeDataHandlerRx xbee_s6_modemStatus_rx  = {
	.identifier = 0x8A,
	.func = xbee_s6_modemStatus_rx_func,
};
struct xbee_modeConType xbee_s6_modemStatus = {
	.name = "Modem Status",
	.allowFrameId = 0,
	.useTimeout = 0,
	.addressRules = ADDR_NONE,
	.rxHandler = &xbee_s6_modemStatus_rx,
	.txHandler = NULL,
};
...
const struct xbee_mode mode_xbee6 = {
	.name = "xbee6",
