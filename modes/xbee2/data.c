...
xbee_err xbee_s2_data_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
void xbee_s2_data_init(struct xbee_modeConType *conType) {
	...
	conType->txHandler->func = xbee_s2_data_tx_func;
}
struct xbee_modeDataHandlerRx xbee_s2_data_rx;
struct xbee_modeDataHandlerTx xbee_s2_data_tx;
struct xbee_modeConType xbee_s2_data = { "Data", &xbee_s2_data_rx, &xbee_s2_data_tx, xbee_s2_data_init };
