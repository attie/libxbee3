...
xbee_err xbee_s2_dataExp_tx_func(struct xbee *xbee, struct xbee_con *con, void *arg, unsigned char identifier, unsigned char frameId, struct xbee_conAddress *address, struct xbee_conSettings *settings, const unsigned char *buf, int len, struct xbee_buf **oBuf) {
...
void xbee_s2_dataExp_init(struct xbee_modeConType *conType) {
	...
	conType->rxHandler->func = xbee_s2_dataExp_rx_func;
	conType->txHandler->identifier = 0x11;
	conType->txHandler->func = xbee_s2_dataExp_tx_func;
}
struct xbee_modeDataHandlerRx xbee_s2_dataExp_rx;
struct xbee_modeDataHandlerTx xbee_s2_dataExp_tx;
struct xbee_modeConType xbee_s2_dataExp = { "Data (explicit)", &xbee_s2_dataExp_rx, &xbee_s2_dataExp_tx, xbee_s2_dataExp_init };
