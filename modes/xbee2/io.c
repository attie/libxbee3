...
xbee_err xbee_s2_io_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
void xbee_s2_io_init(struct xbee_modeConType *conType) {
