...
xbee_err xbee_s1_data_rx_func(struct xbee *xbee, unsigned char identifier, struct xbee_frameInfo *frameInfo, struct xbee_buf *buf, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
