...
xbee_err xbee_s5_data_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
xbee_err xbee_s5_data_tx_func(struct xbee *xbee, struct xbee_con *con, void *arg, unsigned char identifier, unsigned char frameId, struct xbee_conAddress *address, struct xbee_conSettings *settings, const unsigned char *buf, int len, struct xbee_sbuf **oBuf) {
...
struct xbee_modeDataHandlerRx xbee_s5_data_rx  = {
	.identifier = 0x90,
	.func = xbee_s5_data_rx_func,
};
struct xbee_modeDataHandlerTx xbee_s5_data_tx  = {
	.identifier = 0x10,
	.func = xbee_s5_data_tx_func,
};
struct xbee_modeConType xbee_s5_data = {
	.name = "Data",
	.allowFrameId = 1,
	.useTimeout = 0,
	...
	.save_addr16 = 1,
	.save_addr64 = 1,
	.rxHandler = &xbee_s5_data_rx,
	.txHandler = &xbee_s5_data_tx,
};
