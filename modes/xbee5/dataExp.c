...
xbee_err xbee_s5_dataExp_rx_func(struct xbee *xbee, void *arg, unsigned char identifier, struct xbee_tbuf *buf, struct xbee_frameInfo *frameInfo, struct xbee_conAddress *address, struct xbee_pkt **pkt) {
...
xbee_err xbee_s5_dataExp_tx_func(struct xbee *xbee, struct xbee_con *con, void *arg, unsigned char identifier, unsigned char frameId, struct xbee_conAddress *address, struct xbee_conSettings *settings, const unsigned char *buf, int len, struct xbee_sbuf **oBuf) {
...
void xbee_s5_dataExp_init(struct xbee_modeConType *conType) {
	...
	conType->addressRules = ADDR_64_REQUIRED | ADDR_16_NOTALLOW;
